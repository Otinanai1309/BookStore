...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY','ueg#9)g*ys1$p@la-=lpyzq4wdd-m_o7-k84^p(7nsv50h!ap)')
...
ALLOWED_HOSTS = ['my-b00kstore.herokuapp.com',
                 'https://my-b00kstore.herokuapp.com',
                 'my-b00kstore.herokuapp.com/admin'
                 ]
...
# Heroku Sign Up (credentials: karamichailidis@gmail.com, password: Anastasia1410!)
